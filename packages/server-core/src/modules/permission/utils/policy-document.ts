...
export class PolicyDocument implements IPolicyDocument {
  ...
  can(action: string): boolean {
    winstonService.debug('PolicyDocument->can', action);
    ...
    winstonService.debug('PolicyDocument->can->allowResult', allowResult);
    winstonService.debug('PolicyDocument->can->denyResult', denyResult);
